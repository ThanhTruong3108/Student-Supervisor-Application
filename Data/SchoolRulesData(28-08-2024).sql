...
(3, 1, 3, 2, NULL, N'Bỏ tiết/trốn tiết', N'Học sinh cố tình bỏ tiết học', '2023-10-18 10:00:00', '2023-10-18', NULL, 'APPROVED'),
(3, 1, 43, 9, NULL, N'Mặc không đúng quy định', N'Học sinh không tuân thủ quy định về trang phục', '2024-02-20 08:00:00', '2024-02-20', NULL, 'APPROVED'),
(13, 1, 45, 3, 2, N'Phụ kiện không phù hợp', N'Học sinh đeo phụ kiện không được phép bởi nhà trường', '2024-02-25 08:15:00', '2024-02-25', NULL, 'APPROVED'),
(13, 1, 23, 9, 2, N'Quay cóp', N'Học sinh bị bắt quay cóp trong kỳ kiểm tra/thi', '2024-03-08 10:00:00', '2024-03-08', NULL, 'APPROVED'),
(3, 1, 22, 10, NULL, N'Đạo văn', N'Học sinh nộp bài có nội dung đạo văn', '2024-03-12', '2024-03-12', NULL, 'APPROVED'),
...
(3, 2, 29, 17, NULL, N'Gây sự, đánh nhau', N'Học sinh Gây sự, đánh nhau', '2023-11-10 08:00:00', '2023-11-10', NULL, 'APPROVED'),
(14, 2, 34, 17, 4, N'Xả rác bừa bãi', N'Học sinh Xả rác bừa bãi', '2024-04-15 08:15:00', '2024-04-15', NULL, 'APPROVED'),
(14, 2, 23, 19, 4, N'Quay cóp', N'Học sinh bị bắt quay cóp trong kỳ kiểm tra/thi.', '2024-04-20 10:00:00', '2024-04-20', NULL, 'APPROVED'),
(14, 2, 40, 19, 4, N'Trộm cắp tài sản của bạn học, nhà trường', N'Học sinh Trộm cắp tài sản của bạn học, nhà trường', '2024-05-10 14:00:00', '2024-05-10', NULL, 'APPROVED'),
...
(15, 3, 11, 25, 6, N'Mang điện thoại, tư trang quý vào trường', N'Học sinh Mang điện thoại, tư trang quý vào trường', '2024-02-10 10:00:00', '2024-02-10', NULL, 'APPROVED'),
(15, 3, 12, 24, 6, N'Vi phạm luật giao thông', N'Học sinh Vi phạm luật giao thông', '2024-02-15 14:00:00', '2024-02-15', NULL, 'APPROVED'),
...
(3, 4, 2, 33, NULL, N'Đi học trễ', N'Học sinh đi học trễ.', '2023-10-09 08:45:00', '2023-10-09', NULL, 'APPROVED'),
(3, 4, 3, 33, NULL, N'Bỏ tiết/trốn tiết', N'Học sinh cố tình bỏ tiết học.', '2023-11-15 10:00:00', '2023-11-15', NULL, 'APPROVED'),
(3, 4, 43, 31, NULL, N'Mặc không đúng quy định', N'Học sinh không tuân thủ quy định về trang phục.', '2023-12-17 08:00:00', '2023-12-17', NULL, 'APPROVED'),
(3, 4, 45, 26, NULL, N'Phụ kiện không phù hợp', N'Học sinh đeo phụ kiện không được phép bởi nhà trường.', '2024-02-21 08:15:00', '2024-02-21', NULL, 'APPROVED'),
(16, 4, 23, 38, 8, N'Quay cóp', N'Học sinh bị bắt quay cóp trong kỳ kiểm tra/thi.', '2024-04-08 10:00:00', '2024-04-08', NULL, 'APPROVED'),
(16, 4, 22, 34, 8, N'Đạo văn', N'Học sinh nộp bài có nội dung đạo văn.', '2024-05-21 14:00:00', '2024-05-21', NULL, 'APPROVED'),
...
(6, 3, N'Bỏ tiết/trốn tiết', '2023-10-18', '2023-10-22', 'DONE'),
(7, 2, N'Mặc không đúng quy định', '2024-02-20', '2024-02-27', 'DONE'),
(8, 1, N'Phụ kiện không phù hợp', '2024-02-25', '2024-03-02', 'DONE'),
(9, 4, N'Quay cóp', '2024-03-08', '2024-03-14', 'DONE'),
(10, 3, N'Đạo văn', '2024-03-12', '2024-03-19', 'DONE'),
...
(17, 2, N'Gây sự, đánh nhau', '2023-11-10', '2023-11-15', 'DONE'),
(18, 2, N'Xả rác bừa bãi', '2024-04-15', '2024-04-20', 'DONE'),
(19, 4, N'Quay cóp', '2024-04-20', '2024-04-27', 'DONE'),
(20, 3, N'Trộm cắp tài sản của bạn học, nhà trường', '2024-05-10', '2024-05-16', 'DONE'),
...
(29, 1, N'Mang điện thoại, tư trang quý vào trường', '2024-02-10', '2024-02-15', 'DONE'),
(30, 3, N'Vi phạm luật giao thông', '2024-02-15', '2024-02-22', 'DONE'),
...
(35, 5, N'Đi học trễ', '2023-10-09', '2023-10-11', 'DONE'),
(36, 1, N'Bỏ tiết/trốn tiết', '2023-11-15', '2023-11-22', 'DONE'),
(37, 2, N'Mặc không đúng quy định', '2023-12-17', '2023-12-22', 'DONE'),
(38, 3, N'Phụ kiện không phù hợp', '2024-02-21', '2024-02-27', 'DONE'),
(39, 4, N'Quay cóp', '2024-04-08', '2024-04-12', 'DONE'),
(40, 5, N'Đạo văn', '2024-05-21', '2024-05-24', 'DONE'),
...
-- Week 1, January 2024
    (1, N'Điểm thi đua tuần 1 tháng 1', '2024-01-01', '2024-01-07', 90, 'INACTIVE'),
    (2, N'Điểm thi đua tuần 1 tháng 1', '2024-01-01', '2024-01-07', 80, 'INACTIVE'),
    (3, N'Điểm thi đua tuần 1 tháng 1', '2024-01-01', '2024-01-07', 85, 'INACTIVE'),
    (4, N'Điểm thi đua tuần 1 tháng 1', '2024-01-01', '2024-01-07', 95, 'INACTIVE'),
    (5, N'Điểm thi đua tuần 1 tháng 1', '2024-01-01', '2024-01-07', 65, 'INACTIVE'),
    (6, N'Điểm thi đua tuần 1 tháng 1', '2024-01-01', '2024-01-07', 55, 'INACTIVE'),
    (7, N'Điểm thi đua tuần 1 tháng 1', '2024-01-01', '2024-01-07', 100, 'INACTIVE'),
    (8, N'Điểm thi đua tuần 1 tháng 1', '2024-01-01', '2024-01-07', 40, 'INACTIVE'),
    (9, N'Điểm thi đua tuần 1 tháng 1', '2024-01-01', '2024-01-07', 75, 'INACTIVE'),

-- Week 1, Febuary 2024
    (1, N'Điểm thi đua tuần 1 tháng 2', '2024-02-05', '2024-02-11', 100, 'INACTIVE'),
    (2, N'Điểm thi đua tuần 1 tháng 2', '2024-02-05', '2024-02-11', 95, 'INACTIVE'),
    (3, N'Điểm thi đua tuần 1 tháng 2', '2024-02-05', '2024-02-11', 65, 'INACTIVE'),
    (4, N'Điểm thi đua tuần 1 tháng 2', '2024-02-05', '2024-02-11', 75, 'INACTIVE'),
    (5, N'Điểm thi đua tuần 1 tháng 2', '2024-02-05', '2024-02-11', 85, 'INACTIVE'),
    (6, N'Điểm thi đua tuần 1 tháng 2', '2024-02-05', '2024-02-11', 50, 'INACTIVE'),
    (7, N'Điểm thi đua tuần 1 tháng 2', '2024-02-05', '2024-02-11', 60, 'INACTIVE'),
    (8, N'Điểm thi đua tuần 1 tháng 2', '2024-02-05', '2024-02-11', 55, 'INACTIVE'),
    (9, N'Điểm thi đua tuần 1 tháng 2', '2024-02-05', '2024-02-11', 70, 'INACTIVE'),
...
(13, N'Điểm thi đua tuần 1 tháng 8', '2024-08-05', '2024-08-11', 88, 'ACTIVE'),
(14, N'Điểm thi đua tuần 1 tháng 8', '2024-08-05', '2024-08-11', 65, 'ACTIVE'),
(15, N'Điểm thi đua tuần 1 tháng 8', '2024-08-05', '2024-08-11', 75, 'ACTIVE'),
(16, N'Điểm thi đua tuần 1 tháng 8', '2024-08-05', '2024-08-11', 100, 'ACTIVE'),
(17, N'Điểm thi đua tuần 1 tháng 8', '2024-08-05', '2024-08-11', 90, 'ACTIVE'),
(18, N'Điểm thi đua tuần 1 tháng 8', '2024-08-05', '2024-08-11', 80, 'ACTIVE'),

(10, N'Điểm thi đua tuần 2 tháng 8', '2024-08-12', '2024-08-18', 90, 'ACTIVE'),
(11, N'Điểm thi đua tuần 2 tháng 8', '2024-08-12', '2024-08-18', 85, 'ACTIVE'),
(12, N'Điểm thi đua tuần 2 tháng 8', '2024-08-12', '2024-08-18', 75, 'ACTIVE'),
(13, N'Điểm thi đua tuần 2 tháng 8', '2024-08-12', '2024-08-18', 80, 'ACTIVE'),
(14, N'Điểm thi đua tuần 2 tháng 8', '2024-08-12', '2024-08-18', 90, 'ACTIVE'),
(15, N'Điểm thi đua tuần 2 tháng 8', '2024-08-12', '2024-08-18', 95, 'ACTIVE'),
(16, N'Điểm thi đua tuần 2 tháng 8', '2024-08-12', '2024-08-18', 85, 'ACTIVE'),
(17, N'Điểm thi đua tuần 2 tháng 8', '2024-08-12', '2024-08-18', 75, 'ACTIVE'),
(18, N'Điểm thi đua tuần 2 tháng 8', '2024-08-12', '2024-08-18', 60, 'ACTIVE'),

(10, N'Điểm thi đua tuần 3 tháng 8', '2024-08-19', '2024-08-25', 95, 'ACTIVE'),
(11, N'Điểm thi đua tuần 3 tháng 8', '2024-08-19', '2024-08-25', 80, 'ACTIVE'),
(12, N'Điểm thi đua tuần 3 tháng 8', '2024-08-19', '2024-08-25', 70, 'ACTIVE'),
(13, N'Điểm thi đua tuần 3 tháng 8', '2024-08-19', '2024-08-25', 85, 'ACTIVE'),
(14, N'Điểm thi đua tuần 3 tháng 8', '2024-08-19', '2024-08-25', 95, 'ACTIVE'),
(15, N'Điểm thi đua tuần 3 tháng 8', '2024-08-19', '2024-08-25', 75, 'ACTIVE'),
(16, N'Điểm thi đua tuần 3 tháng 8', '2024-08-19', '2024-08-25', 65, 'ACTIVE'),
(17, N'Điểm thi đua tuần 3 tháng 8', '2024-08-19', '2024-08-25', 65, 'ACTIVE'),
(18, N'Điểm thi đua tuần 3 tháng 8', '2024-08-19', '2024-08-25', 80, 'ACTIVE'),

(10, N'Điểm thi đua tuần 4 tháng 8', '2024-08-26', '2024-08-31', 100, 'ACTIVE'),
(11, N'Điểm thi đua tuần 4 tháng 8', '2024-08-26', '2024-08-31', 75, 'ACTIVE'),
(12, N'Điểm thi đua tuần 4 tháng 8', '2024-08-26', '2024-08-31', 95, 'ACTIVE'),
(13, N'Điểm thi đua tuần 4 tháng 8', '2024-08-26', '2024-08-31', 50, 'ACTIVE'),
(14, N'Điểm thi đua tuần 4 tháng 8', '2024-08-26', '2024-08-31', 60, 'ACTIVE'),
(15, N'Điểm thi đua tuần 4 tháng 8', '2024-08-26', '2024-08-31', 75, 'ACTIVE'),
(16, N'Điểm thi đua tuần 4 tháng 8', '2024-08-26', '2024-08-31', 90, 'ACTIVE'),
(17, N'Điểm thi đua tuần 4 tháng 8', '2024-08-26', '2024-08-31', 70, 'ACTIVE'),
(18, N'Điểm thi đua tuần 4 tháng 8', '2024-08-26', '2024-08-31', 80, 'ACTIVE');