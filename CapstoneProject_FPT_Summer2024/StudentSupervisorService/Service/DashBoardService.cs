...
namespace StudentSupervisorService.Service
{
    ...
    {
        Task<DataResponse<List<ResponseOfViolation>>> GetViolationsByMonthAndWeek(int schoolId, short year, int? month = null, int? weekNumber = null);
        ...
        Task<DataResponse<List<ClassViolationSummary>>> GetClassesWithMostViolations(int schoolId, short year, int? month = null, int? weekNumber = null);
        ...
        Task<DataResponse<List<ClassViolationDetail>>> GetClassWithMostStudentViolations(int schoolId, short year, int? month = null, int? weekNumber = null);
