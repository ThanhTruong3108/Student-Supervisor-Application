...
namespace StudentSupervisorService.Service
{
    public interface ViolationService
    {
        ...
        Task<DataResponse<ResponseOfViolation>> CreateViolation(RequestOfViolation request);
        Task DeleteViolation(int id);
        Task<DataResponse<ResponseOfViolation>> UpdateViolation(int id, RequestOfViolation request);
